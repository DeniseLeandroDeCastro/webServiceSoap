...
public class MyFirstSOAPWebServiceServiceLocator extends org.apache.axis.client.Service implements br.edu.ifrn.ws.soap.MyFirstSOAPWebServiceService {
    ...
    private java.lang.String MyFirstSOAPWebServicePort_address = "http://denise:8080/IfrnWebServicesProject/MyFirstSOAPWebServiceService";
    ...
    public br.edu.ifrn.ws.soap.MyFirstSOAPWebService getMyFirstSOAPWebServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public br.edu.ifrn.ws.soap.MyFirstSOAPWebService getMyFirstSOAPWebServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.edu.ifrn.ws.soap.MyFirstSOAPWebServicePortBindingStub _stub = new br.edu.ifrn.ws.soap.MyFirstSOAPWebServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.edu.ifrn.ws.soap.MyFirstSOAPWebService.class.isAssignableFrom(serviceEndpointInterface)) {
                br.edu.ifrn.ws.soap.MyFirstSOAPWebServicePortBindingStub _stub = new br.edu.ifrn.ws.soap.MyFirstSOAPWebServicePortBindingStub(new java.net.URL(MyFirstSOAPWebServicePort_address), this);
                _stub.setPortName(getMyFirstSOAPWebServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soap.ws.ifrn.edu.br/", "MyFirstSOAPWebServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soap.ws.ifrn.edu.br/", "MyFirstSOAPWebServicePort"));
        }
